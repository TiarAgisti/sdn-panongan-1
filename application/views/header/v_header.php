<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url(); ?>asset/vendors/css/bootstrap.min.css">
  <script src="<?php echo base_url(); ?>asset/vendors/js/jquery.min.js"></script>
  <script src="<?php echo base_url(); ?>asset/vendors/js/bootstrap.min.js"></script>
  <!-- endinject -->
